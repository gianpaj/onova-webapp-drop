...
2. Remove unused styles from CSS with `uncss`

        uncss http://localhost:3000/faq.src.html > public/static.min.css

3. Update the html source file (`faq.src.html`):

    1. uncomment `quill.core.min.css` and `core.min.css` stylesheets

    2. comment `css/static.min.css` stylesheets
